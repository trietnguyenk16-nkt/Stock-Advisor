...
export type PortfolioAnalysis = { ticker: string; name: string; signal: "BUY" | "SELL" | "HOLD"; summary: string; referencePrice: number | null; targetPrice: number | null; risk: string; confidence: number | null; strategy?: string; entryZone?: string; positionSizing?: string; takeProfit?: string; stopLoss?: string; invalidation?: string; news: Array<{ title: string; publisher: string; link: string; publishedAt: string | null }> };
